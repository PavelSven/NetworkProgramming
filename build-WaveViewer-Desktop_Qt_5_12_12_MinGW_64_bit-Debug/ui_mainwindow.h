...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/ICO/Ico/wave_85842.ico"), QSize(), QIcon::Normal, QIcon::Off);
        MainWindow->setWindowIcon(icon);
        actionWave_viewer = new QAction(MainWindow);
        actionWave_viewer->setObjectName(QString::fromUtf8("actionWave_viewer"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/ICO/Ico/audiowave_85916.ico"), QSize(), QIcon::Normal, QIcon::Off);
        actionWave_viewer->setIcon(icon1);
        actionAbout = new QAction(MainWindow);
        actionAbout->setObjectName(QString::fromUtf8("actionAbout"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/ICO/Ico/about.ico"), QSize(), QIcon::Normal, QIcon::Off);
